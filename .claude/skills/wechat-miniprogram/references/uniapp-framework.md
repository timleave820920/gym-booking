...
**支持平台：** 微信/支付宝/百度/字节/QQ/快应用/H5/App (iOS + Android)
...
组合：`#ifdef MP-WEIXIN || MP-ALIPAY`（多平台）
...
uni-app 直接支持 rpx，与微信小程序一致（750rpx = 屏幕宽度）：
